...
public class SZTandroid {
     ...
     *0 为成功，其它返回值请参考错误返回码
     *****************************/
    public native int SZTOpenDeviceEx(int fd,int nDeviceType,int iCom,int iBaud,int nPackageSize/*=2*/,int iDevNum/*=0*/);
    /*********************************
     *获取图像函数
     ...
     *0 为成功，其它返回值请参考错误返回码
     ***********************************/
    public native int SZTSetImageSize(int imagesize);
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************/
    public native int SZTCloseDeviceEx();
    /*********************************
     *获取图像函数
     *参数：
     *nAddr： 0xffffffff
     ...
     *0 为成功，其它返回值请参考错误返回码
     ***********************************/
    public native int SZTGetImage(int nAddr);
    /*********************************
     *生成特征码函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ***********************************/
    public native int SZTGenChar(int nAddr,int iBufferID);
    /*********************************
     ...
     *0 为成功，其它返回值请参考错误返回码
     ***********************************/
    public native int SZTMatch(int nAddr,int[] iScore);
     ...
     *0 为成功，其它返回值请参考错误返回码
     ***********************************/
    public native int SZTSearch(int nAddr,int iBufferID, int iStartPage, int iPageNum, int[] iMbAddress/*int *iscore=NULL*/);
     ...
     *0 为成功，其它返回值请参考错误返回码
     ***********************************/
    public native int SZTRegModule(int nAddr);
     ...
     *0 为成功，其它返回值请参考错误返回码
     *********************************************************************/
    public native int SZTStoreChar(int nAddr,int iBufferID, int iPageID);
    /*******************************************************************
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTLoadChar(int nAddr,int iBufferID,int iPageID);
     ...
     *0 为成功，其它返回值请参考错误返回码
     ***********************************/
    public native int SZTSetCharLen(int charLen);
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTUpChar(int nAddr,int iBufferID, byte[] pTemplet,int[] iTempletLength);
    /*******************************************************************
     *11、下载特征函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTDownChar(int nAddr,int iBufferID, byte[] pTemplet, int iTempletLength);
    /*******************************************************************
     *12、上传图像函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTUpImage(int nAddr,byte[] pImageData,int[] iTempletLength);
    /*******************************************************************
     *13、下载图像函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTDownImage(int nAddr,byte[] pImageData, int iLength);
    /*******************************************************************
     *14、图像数据保存成 BMP 图片函数
     *参数：
    ...
    public native int SZTImgData2BMP(byte[] pImgData,String str);
    /*******************************************************************
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTDelChar(int nAddr,int iStartPageID,int nDelPageNum);
    /*******************************************************************
     *17、清空指纹库函数
     *参数：
     *nAddr： 0xffffffff
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTEmpty(int nAddr);
    /*******************************************************************
     *18、读参数表函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTReadParTable(int nAddr,byte[] pParTable);
    /*******************************************************************
     *19、快速比对函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTHighSpeedSearch(int nAddr,int iBufferID, int iStartPage, int iPageNum, int[] id_iscore);
    /*******************************************************************
     *20、读取有效模板数量函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTTemplateNum(int nAddr,int[] iMbNum);
    /*******************************************************************
     *21、设置设备握手口令函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTSetPwd(int nAddr,byte[] pPassword);
    /*******************************************************************
     *22、验证设备握手口令函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTVfyPwd(int nAddr,byte[] pPassword);
    /*******************************************************************
     *23、读取用户信息函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTReadInfo(int nAddr,int nPage,byte[] UserContent);
    /*******************************************************************
     *24、写入用户信息函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTWriteInfo(int nAddr,int nPage,byte[] UserContent);
    /*******************************************************************
     *25、设置波特率函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTSetBaud(int nAddr,int nBaudNum);
    /*******************************************************************
     *26、设置安全等级函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTSetSecurLevel(int nAddr,int nLevel);
    /*******************************************************************
     *27、设置数据包大小函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTSetPacketSize(int nAddr,int nSize);
    /*******************************************************************
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTUpChar2File(int nAddr,int iBufferID, byte[] pFileName);
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTDownCharFromFile(int nAddr,int iBufferID, byte[] pFileName);
    /*******************************************************************
     *30、获取随机数函数
     *参数：
     *nAddr： 0xffffffff ；
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTGetRandomData(int nAddr,byte[] pRandom);
     ...
     *0 为成功，其它返回值请参考错误返回码
     ********************************************************************/
    public native int SZTSetChipAddr(int nAddr,byte[] pChipAddr);
