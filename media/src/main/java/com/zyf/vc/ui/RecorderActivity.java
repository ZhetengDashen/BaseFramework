...
/**
 * Created by magiclon on 2018/9/4.
 */
public class RecorderActivity extends Activity implements IVideoRecorder {
    ...
    private final static int MAX_TIME = 122;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getExtras()!=null){
            recordPath=getIntent().getStringExtra("videoPath");
        }
        setContentView(R.layout.activity_record);

        mPreview = findViewById(R.id.camera_preview);
        record_pb = findViewById(R.id.record_pb);
    ...
    public void stopRecord() {
        if (isRecording&&record_pb.getmPastTime()>MIN_TIME*1000) {
            ...
            intent.putExtra(PlayVideoActiviy.KEY_FILE_PATH, recordPath);
...
//        recordPath = path+System.currentTimeMillis()+".mp4";
...
//        mMediaRecorder.setVideoEncodingBitRate(540 * 720);
